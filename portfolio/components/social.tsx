    ...
    <div className="flex flex-row mt-5">
        <div className="md:mx-10 mx-5">
            <div className="flex items-center relative justify-center">
                ...
                target="_blank"
                className="absolute md:w-10 md:h-10 w-5 h-5 rounded-full mr-4 md:hover:w-14 md:hover:h-14 hover:w-8 hover:h-8 hover:bg-green-500 ease-in duration-[250ms]">
                    <Image 
        ...
        <div className="md:mx-10 mx-5">
            <div className="flex items-center relative justify-center">
                ...
                target="_blank"
                className="absolute md:w-11 md:h-11 w-5 h-5 rounded-full mr-4 md:hover:w-14 md:hover:h-14 hover:w-8 hover:h-8 hover:bg-green-500 ease-in duration-[250ms]">
                    <Image 
